...
import { Menu, X, Search, TrendingUp, Star, Radar, Settings, Wallet, TestTube, Globe, LayoutDashboard, Heart } from 'lucide-react';
...
export const Navbar = ({ onSearch }) => {
  ...
  const navLinks = [
    ...
    { path: '/watchlist', label: 'Listelerim', icon: Heart },
